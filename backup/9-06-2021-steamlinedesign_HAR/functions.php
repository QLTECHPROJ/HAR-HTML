...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'twentytwenty-newjquery', 'code.jquery.com/jquery-1.11.0.min.js', array(), $theme_version, false );
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							foreach ($result as $k => $va){
								...
								?>		
								<tr>
									<td ><a href="/HAR/my-account/view-pets/<?php echo $va->id;?>"><?php echo $va->pet_animal_name; ?></a></td>
									<td >
										<?php
										if($va->species=='')
										{
...
add_action( 'woocommerce_before_checkout_form', 'the_dramatist_page_breadcrumbs_checkout');
