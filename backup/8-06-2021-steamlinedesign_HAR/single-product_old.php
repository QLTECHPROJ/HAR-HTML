            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
            	<div class="product_detailscnt">
                  ...
                  <div class="proreviewbx">
                    ...
                    <p>
                      <a href="javascript:void(0)" data-id="review" data-toggle="tab" class="star_reviewtxt gotorating">
                      ...
                      {
                        ?>
                        <div class="star-rating" data-id="ratingboxscroll" data-toggle="tab">
                        </div>
                        <?php 
                      }
                   ?> 
...
?>
    ...
    <div class="alremedistabing_sec" id="ratingboxscroll">
        <div class="container">
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li class="nav-item" >
              <a class="nav-link" data-toggle="tab" data-id="ratingboxscroll" href="#review"  >Review</a>
            </li>
          </ul>
...
<script type="text/javascript">
 ...
 /*review click scroll tab js*/
 /*$('.star-rating').on('click', function() {
    $('.nav-tabs a[href="#review"]').tab('show');
    $('html, body').animate({
        scrollTop: $(".alremedistabing_sec").offset().top
    }, 2000);
});*/
