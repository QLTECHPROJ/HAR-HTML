            ...
            <div class="col-lg-6 col-md-6 col-sm-6">
            	<div class="product_detailscnt">
                  ...
                  <div class="proreviewbx">
                    ...
                    <p>
                      <a href="javascript:;" data-id="ratingboxscroll" class="star_reviewtxt gotorating">
              ...
              ?>
                ...
                <div class="quality_cartbtn">
                  ...
                  else
                  {
                    ...
                    <!-- <button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="btn-main triggerbutton" id="variation_url"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button> -->
                    <input type="button" name="add-to-cart" class="btn-main triggerbutton" value="Add To Cart">
                    <?php
