          ...
          <div class="bundlepodouct_mainbx">
            <div class="bundlerow_box">
              <div class="row align-items-center">
                <div class="col-lg-2 col-md-3 col-sm-4">
                  <div class="thumbimg"><img src="https://steamlinedesign.com/HAR/wp-content/uploads/2021/01/product_img1.jpg" alt=""></div>
                </div>
                <div class="col-lg-5 col-md-3 col-sm-4">
                  <div class="bundtabcnt">Woo Single #1</div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-4">
                  <div class="bundeleaqtybx">
                    <div class="qtnbx">
                      <input type="text" id="bundeleaqty" class="form-control">
                        <button type="button" class="altera acrescimo onchangequ">+</button>
                        <button type="button" class="altera decrescimo onchangequ1">-</button>
                    </div><!--qtnbx-->
                  </div>
            ...
            <div class="bundlerow_box">
              <div class="row align-items-center">
                ...
                <div class="col-lg-5 col-md-3 col-sm-4">
                  <div class="bundtabcnt">Ship Your Idea</div>
                  <span>color</span>
                  <div class="select_box">
                    <span class="select_arrow"></span>
