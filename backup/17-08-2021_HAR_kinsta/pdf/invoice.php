...
<div class="madbysection">
	<div class="madbyseclist">made by<span></span></div>
	<div class="madbyseclist">checked by<span></span></div>
		...
		<table class="order-details">
			...
			<tbody>
				...
				<tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?>">
					...
					<td class="product_sku"><?php if( !empty( $item['sku'] ) ) : ?><dt class="sku"><?php _e( '', 'woocommerce-pdf-invoices-packing-slips' ); ?></dt><dd class="sku"><?php echo $item['sku']; ?></dd><?php endif; ?></td>	
					<td class="product ">
