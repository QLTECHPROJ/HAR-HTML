                ...
                <figcaption>
                	<div class="container">
                		<div class="hbanner_cnt">
                            <?php/* <h1><?php echo get_field('name')?></h1>*/?>
            ...
            <div class="row">
            	<div class="col-lg-6 col-md-6 col-sm-6">
                	<div class="hominalimg">
                    	<img src="<?php echo get_template_directory_uri() . '/assets/images/new_image_cow.jpg'?>" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
        ...
        the_excerpt(); */
            	...
            	<div>
                    ...
                    <div class="clientslidecnt mt-2 mt-md-3 mt-lg-4">
                    	<p><?php echo get_field('message')?>... <a href="javascript:;"data-toggle="modal" data-target="#myModal" class="readmorebtn">read more</a></p>
                	...
                	<div class="col-lg-6 col-md-6 col-sm-6">
                    	<div class="productcat_box">
                            ...
                            <div class="prodctcntbx">
                                ...
                                <a href="https://steamlinedesign.com/HAR/wp-content/uploads/2021/02/test_animal.pdf" download class="btn-main tbtnpurpal">Download Catalogue</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                    	<div class="productcat_box">
                            ...
                            <div class="prodctcntbx">
                            	<h5 class="m-0">한국어</h5>
                                <p>한국어 카탈로그 다운로드</p>
                                <a href="https://steamlinedesign.com/HAR/wp-content/uploads/2021/02/test_animal.pdf" download class="btn-main tbtnpurpal">카탈로그 다운로드</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal testionial_popupbx" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
        <button type="button" class="close" data-dismiss="modal">&times;</button>      
          <div class="modal-body">
            <div class="clientslideimg"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/client_sliderimg.jpg" alt=""></div>
