  ...
  <div class="headertop">
    	<div class="container">
        	<div class="header_topleft">
                ...
                {
                ?>
                <a href="<?php echo get_home_url();?>/my-account/" class="hthreiconcntbx"><i class="fas fa-shield-alt"></i>Login Or Register</a>
                <?php
              }
              else
              {
                ?>
                <a href="<?php echo get_home_url();?>/my-account/" class="hthreiconcntbx"><i class="fas fa-shield-alt"></i><?php echo "Hi, ".$first_name.' '.$last_name;?></a>
                <?php
              }
              ?>
            </div>
        ...
        <div class="container">
           ...
           <div class="headrright">
                ...
                <div class="searchbxmo">
                    ...
                    <div id="display"></div>
                      <?php/* <?php echo do_shortcode('[aws_search_form]');?>
                    <?php //if ( function_exists( 'aws_get_search_form' ) ) { aws_get_search_form(); } ?> */?>
                    </div>
               </div><!--searchbxmo-->
