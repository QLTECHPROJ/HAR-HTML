...
?>
          ...
          <?php
           ...
           // echo $pdf_check;
            ...
            $help_shhet_product = get_the_id();
            if($help_shhet_product==6027)
            {
              ?>
               <div class="helpsheet_bx">
              <div class="pdf_bx">
                  <a href="https://steamlinedesign.com/HAR/wp-content/uploads/2021/07/110and42PETDRUGSANDSIDEEFFECTS-1600072721287-2.pdf" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Pdf_icon.png"></a>
              </div>
            </div>
              <?php
            }
            if($help_shhet_product==5825 || $help_shhet_product==6063)
            {
              ?>
              <div class="pdf_bx">
                  <a href="https://steamlinedesign.com/HAR/wp-content/uploads/2021/07/013a13b13c13d252829a29b3393a164171172a172b181188191198206207213216235245242247280313326-1619845896588.pdf" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Pdf_icon.png"></a>
              </div>
              <?php
            }
            if($help_shhet_product==3175)
            {
              ?>
              <div class="pdf_bx">
                  <a href="https://steamlinedesign.com/HAR/wp-content/uploads/2021/07/110and42PETDRUGSANDSIDEEFFECTS-1600072721287-2.pdf" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Pdf_icon.png"></a>
...
$('.slick-slide').on( "click", function() {
  ...
  if($('.slick-slide').hasClass('slick-current'))
  {
    ...
    if(check_text)
    {
      ...
      $('.gallery_img_box').attr('href',check_text);
