						...
						<td class="woocommerce-orders-table__cell woocommerce-orders-table__cell-<?php echo esc_attr( $column_id ); ?>" data-title="<?php echo esc_attr( $column_name ); ?>">
							...
							<?php elseif ( 'order-number' === $column_id ) : ?>
								<a href="<?php echo esc_url( $order->get_view_order_url() ); ?>">
									<span><?php echo esc_html( _x( '#', 'hash before order number', 'woocommerce' ) . $order->get_order_number() ); ?></span>
								</a>
...
$args = array(
    ...
    'mid_size'      => 2,
    'prev_next'     => true,
    'prev_text' => __('&laquo;'), //with text and symbol //'prev_text' => __('&laquo; Previous'),
    'next_text' => __('&raquo;'), //with text and symbol  // 'next_text' => __('Next &raquo;'),
    'type'          => 'plain',
    'add_args'      => false,
    'add_fragment'  => ''
);
