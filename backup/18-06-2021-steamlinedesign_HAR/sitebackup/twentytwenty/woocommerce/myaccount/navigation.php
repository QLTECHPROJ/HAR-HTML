...
$icons = [
    ...
    '../wholesale-ordering/' => '<img src="https://steamlinedesign.com/HAR/wp-content/themes/twentytwenty/assets/images/quick-order.svg" class="dblisticon">'
];
?>
<nav class="woocommerce-MyAccount-navigation">
	<div class="dashboard_list sidebar_sticky ">
