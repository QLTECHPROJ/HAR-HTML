	...
	<div class="col-lg-6 col-md-6 col-sm-12">
       <div class="dashboardtabbx">
          ...
          <div class="dashboardtabtxt">
            ...
            <a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-account', $uemail ) ); ?>" class="editprofbtn"><?php echo $uemail ? esc_html__( 'Edit Profile', 'woocommerce' ) : esc_html__( 'Add Profile', 'woocommerce' ); ?></a>
	...
	<div class="col-lg-6 col-md-6 col-sm-12">
        ...
        <div class="dashboardtabbx dbcnttxtalign">
           ...
           <div class="defaultbtn"><span class="default_title">Default</span></div>
			...
			<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>" class="editemailadd"><?php echo $address ? esc_html__( 'Edit Address', 'woocommerce' ) : esc_html__( 'Add Address', 'woocommerce' ); ?></a>
...
<div class="col-lg-12 col-md-12 col-sm-12">
          ...
          <table class="table table-bordered">
			...
			foreach($customer_orders as $order ){
				...
				<tr>
					...
					<td><a class="woocommerce-button button view" href="https://steamlinedesign.com/HAR/my-account/view-order/<?php echo $order_id;?>">View</a></td>
				</tr>
			<?php
	...
	<p class="noorderdash">No order has been made yet</p>
	<?php
	}
	?>
	  </div>
