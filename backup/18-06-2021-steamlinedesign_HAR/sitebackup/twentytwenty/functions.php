...
function twentytwenty_register_scripts() {
	...
	wp_enqueue_script( 'twentytwenty-mCustomScrollbar', get_template_directory_uri() . '/assets/js/jquery.mCustomScrollbar.js', array(), $theme_version, false );
	...
	wp_enqueue_script( 'twentytwenty-newjquery', get_template_directory_uri() . '/assets/js/slick.js', array(), $theme_version, true );
...
class Primary_Walker_Nav_Menu extends Walker_Nav_Menu {
	...
	function start_lvl(&$output, $depth=0,$args = NULL) {
      ...
      // Change sub-menu to dropdown menu
		$output .= "\n$indent<ul class=\"dropdown-menu main-menu petmenubx scrollable-menu\">\n";
...
//echo $user_id;
	...
	$result = $wpdb->get_results("SELECT max(id) as id,pet_animal_name,species,breed,age FROM har_save_pet_order_data WHERE user_id = '$user_id' AND flag = 0 GROUP BY pet_animal_name ORDER BY id DESC");
    ...
    <div class="col-lg-7 col-md-8 col-sm-12">
      <form method="post" class="woocommerce-form woocommerce-form-register register registerform contact-form" <?php do_action( 'woocommerce_register_form_tag' ); ?> >
			...
			<p class="woocommerce-form-row form-row">
				...
				<button type="submit" id="check_register" disabled="disabled" class="woocommerce-Button woocommerce-button button woocommerce-form-register__submit btn-main disabled" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>"><?php esc_html_e( 'Register', 'woocommerce' ); ?></button>
			</p>
  		  		   	...
  		  		   	{ 
  		  		   		$('#result').removeClass();
  		  		   		 ...
  		  		   		 $('#check_register').prop("disabled", false);
  		  		   		  return 'Strong: Your password is strong. - Please enter a stronger password. <br> Hint: The password should be at least twelve characters long. To make it stronger, use upper and lower case letters, numbers, and symbols like ! " ? $ % ^ & ).';
  		  		   		} 
  	} 
 });
</script>
