...
<section class="home_page">
	...
	<div class="spcies_agesec">
    	<div class="container">
            ...
            <div class="speciesagerowsec mt-1 mt-md-5">
            	<div class="row">
                    <?php
...
if( !empty($product_categories) ){
    ...
    <div class="hominomal_sec">
    	<div class="container">
        	<h2 class="mb-2 mb-md-5">HERE'S WHERE HOMEOANIMAL ™ SHINES</h2>
            <div class="row">
 ...
 $args = array(  
    ...
    while ( $loop->have_posts() ) : $loop->the_post(); 
        ...
        the_excerpt(); */
            	...
            	<div>
                    ...
                    <div class="clientslidecnt mt-3 mt-md-4">
    ...
    <div class="monthlyanimalfundig_sec">
    	<div class="container">
        	...
        	<div class="monthlyaimgbx mt-2 mt-md-5"><img src="<?php echo get_template_directory_uri() . '/assets/images/donation.jpg'?>" alt=""></div>
    ...
    <div class="animalfunding_sec">
    	<div class="container">
        	...
        	<div class="customer_logo pt-2 pt-md-5">
                <?php
 $args = array(  
        'post_type' => 'post',
        'post_status' => 'publish',
