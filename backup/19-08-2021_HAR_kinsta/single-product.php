    	...
    	<div class="row">
           ...
           <div class="row">
              ...
              <div class="remediest_prosliderbxmain sidebar_sticky">
                <div class="slider slider-largeimg gallerybox">
                  <div>
                   <!--<div class="remedilargeimg"><img src="<?php echo wp_get_attachment_url( $product->get_image_id() ); ?>" alt=""></div>--->
                     <div class="remedilargeimg gallery_box_section">
                        <div class="gallery-box">
                            <div class="black-bg">
                                <a class="detail gallery_img_box" data-fancybox="group" href="" alt="" class="img-fluid"></a>
                            </div>
                            <div class="gallery-img">
                                <img src="<?php echo wp_get_attachment_url( $product->get_image_id() ); ?>" alt="" class="img-fluid">
                            </div>
                        </div><!--gallery-box-->
                    </div><!--remedilargeimg-->
                  </div>
...
?>
              ...
              $check_product_2 = get_post_meta( $product->get_id(), '_custom_product_text_field_yes_no', true );

                  //echo $check_product_2;

                  $check_order_2 =  has_bought_items($product->get_id());

                  //echo $check_order_2;

              if(($check_product_2=='no' || $check_product_2=='No' || $check_product_2=='nO' || $check_product_2=='NO') && $check_order_2==1)
              {
                  if($product->product_type === 'simple')
                  {
                ...
                else if((($check_product_2=='no' || $check_product_2=='No' || $check_product_2=='nO' || $check_product_2=='NO') && $check_order_2==0))
                {
                    echo "Individual items from sets are available, after the “initial purchase” the full Set";
                }
                else if($check_product_2=='')
                {
                      if($product->product_type === 'simple')
                  {
          ...
          <div class="qulityshipping">
            <p><i class="fas fa-truck"></i>FREE SHIPPING on orders $100+</p>
          </div>
          <div class="qulitysatisfied">
            <p><i class="fas fa-shield-alt"></i>SATISFACTION GUARANTEED*</p>
          </div>
          <div class="scollbuttonlink">
            <a class="qulity_scrolltxt" href="#scrollfreqnt" data-id="scrollfreqnt" >Lorem ipsum</a>
          </div>
          <?php
...
?>
    ...
    ?>
            ...
            <div id="healthinfo" class="tab-pane active text-purpal">
              <!-- <h3>Lorem ipsum dolor sit amet</h3> -->
              <p><?php echo get_field('health_info');?></p>
              
            </div>
            <div id="ingredient" class="tab-pane fade text-purpal">
             <!--  <h3>Lorem ipsum dolor sit amet</h3> -->
              <p><?php echo get_field('ingredients');?></p>
            </div>
            <div id="dosinginfo" class="tab-pane fade text-purpal">
              <!-- <h3>Lorem ipsum dolor sit amet</h3> -->
...
<?php
 $crosssellProductIds   =   get_post_meta( get_the_ID(), '_wc_pb_bundle_sell_ids' );
$crosssellProductIds    =   $crosssellProductIds[0];

if(!empty($crosssellProductIds))
{
  ?>
 <div class="youmayalsolike_morepro_sec" id="scollbutton">
    <div class="container ">
      <div class="recentyview_sec youmayalsolikesec" id="scrollfreqnt" data-id="scrollfreqnt">
...
foreach($crosssellProductIds as $id):
    ...
    <div class="col-lg-3 col-md-3 col-sm-6">
      <div class="remediesboxcol">
        <a class="remediesimg" href="<?php echo get_permalink($id); ?>" title="Show details for Watches">
        ...
        <?php
        $contenttitle = mb_strimwidth($product->name, 0, 60, '...');
        ?>
        <a class="product-name" href="<?php echo get_permalink($id); ?>"><?php echo $contenttitle;?></a>
...
$('.slick-slide').on( "click", function() {
  ...
  if($('.slick-slide').hasClass('slick-current'))
  {
    ...
    if(check_text)
    {
      ...
      $('.gallery-img').children('img').attr('src',check_text);
      $('.gallery_img_box').attr('href',join);
...
$('.slider-thumbeimg').slick({
 ...
 $(".scollbuttonlink a").click(function() {
    $('html, body').animate({
        scrollTop: $("#"+$(this).attr('data-id')).offset().top - ($('.header').height()+100)
    }, 1000);
});
</script>
