                ...
                <div class="slider slider-largeimg gallerybox">
                  <div>
                   <!--<div class="remedilargeimg"><img src="<?php echo wp_get_attachment_url( $product->get_image_id() ); ?>" alt=""></div>--->
                    <div class=" gallery_box_section">
                        <div class="gallery-box remedilargeimg">
                            <div class="black-bg">
                                <a class="detail gallery_img_box" data-fancybox="group" href="<?php echo wp_get_attachment_url( $product->get_image_id() ); ?>" alt="" class="img-fluid"></a>
                            </div>
